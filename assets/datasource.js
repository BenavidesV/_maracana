...
export let timelineResourceData = [
    {
        Id: 61,
        Subject: 'Decoding',
...
export let resourceConferenceData = [
    {
        Id: 1,
        Subject: 'Burning Man',
...
export function generateObject(start = new Date(2017, 6, 1).getTime(), end = new Date(2018, 6, 31).getTime()) {
    let data = [];
    let names = [
    ...
    for (let a = start, id = 1; a < end; a += (dayCount * 24) * 2) {
